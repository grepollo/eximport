...
class Entry_details extends REST_Controller {
	...
	public function __construct()
	{
		...
		//}
		$this->load->model('Job_entry_detail_model', 'model');
	}
	...
	public function create_post() 
	{
		$data = $this->post();
        $data['finishedQty'] = 0;
        $data['balancedQty'] = $data['quantity'];
