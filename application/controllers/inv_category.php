...
class Inv_category extends REST_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('Inv_category_model', 'model');
	}
	...
	{
		$id = $this->post('invCategoryId');
		$where = array('invCategoryId' => $id);
		$data = $this->post();
	...
	{
		$data = $this->post();
		$where = "invCategoryId = {$data['invCategoryId']}";
